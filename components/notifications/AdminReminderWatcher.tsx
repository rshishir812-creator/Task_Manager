    ...
    <AnimatePresence>
      {banner && (
        <motion.div
          ...
          exit={{ opacity: 0, y: -30 }}
          className="fixed top-below-header left-1/2 -translate-x-1/2 z-40 w-[calc(100%-1.5rem)] max-w-md px-4 py-3 rounded-2xl bg-bg-elevated border border-accent-amber/40 shadow-lg"
        >
